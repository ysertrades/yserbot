...
const WRITE_ERRORS = {
  ...
  bad_avatar:      'Avatar must be an https image link or a pasted image.',
...
function renderBotProfile() {
  ...
  if (bp.canEditGlobal) {
    ...
    nodes.push(textField('Avatar URL (https) or leave blank', globalDraft.avatar, v => { globalDraft.avatar = v; }, {
      placeholder: 'Paste an https image link to replace the avatar',
    }));
