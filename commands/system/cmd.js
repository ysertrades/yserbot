...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const syncNote = synced
      ...
      : '\n⚠️ Could not update Discord command visibility automatically. Go to **Server Settings → Integrations → QuantLab** to set it manually.';
