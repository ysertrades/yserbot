...
import { useEffect as useEffect13, useState as useState9, useRef as useRef17, useCallback as useCallback12 } from "react";
...
function ControlRenderer({ panelId, controls, values, transitionDuration }) {
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "folder":
        return /* @__PURE__ */ jsx15(Folder, { title: control.label, defaultOpen: control.defaultOpen ?? true, children: control.children?.map(renderControl) }, control.path);
      case "text":
        return /* @__PURE__ */ jsx15(
          TextControl,
          {
  ...
  return /* @__PURE__ */ jsx15(Fragment3, { children: controls.map(renderControl) });
}
...
function PresetManager({ panelId, presets, activePresetId, onAdd }) {
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "dialkit-preset-manager", children: [
    ...
    createPortal2(
      /* @__PURE__ */ jsx16(AnimatePresence3, { children: isOpen && /* @__PURE__ */ jsxs10(
        motion4.div,
        {
          ref: dropdownRef,
...
function Panel({ panel, defaultOpen = true, inline = false, onOpenChange, variant = "root", toolbarExtra }) {
  ...
  const renderControls = () => /* @__PURE__ */ jsx17(ControlRenderer, { panelId: panel.id, controls: panel.controls, values });
  const iconTransition = { type: "spring", visualDuration: 0.4, bounce: 0.1 };
  const toolbar = /* @__PURE__ */ jsxs11(Fragment4, { children: [
    /* @__PURE__ */ jsx17(
      motion5.button,
      {
    ...
    /* @__PURE__ */ jsx17(
      motion5.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: /* @__PURE__ */ jsx17("span", { style: { position: "relative", width: 16, height: 16 }, children: /* @__PURE__ */ jsx17(AnimatePresence4, { initial: false, mode: "wait", children: copied ? /* @__PURE__ */ jsx17(
          motion5.svg,
          {
            viewBox: "0 0 24 24",
            fill: "none",
  ...
  if (variant === "section") {
    return /* @__PURE__ */ jsxs11(Folder, { title: panel.name, open: isOpen, onOpenChange: handleOpenChange, children: [
...
function DialRoot({ position = "top-right", defaultOpen = true, mode = "popover", theme = "system", productionEnabled = isDevDefault, onOpenChange }) {
  ...
  const content = /* @__PURE__ */ jsx19(ShortcutListener, { children: /* @__PURE__ */ jsx19("div", { className: "dialkit-root", "data-mode": mode, "data-theme": theme, children: /* @__PURE__ */ jsx19(
    "div",
    {
      ...
      ) }) : hasMultiplePanels ? /* @__PURE__ */ jsx19("div", { className: "dialkit-panel-wrapper", children: /* @__PURE__ */ jsx19(
        Folder,
        {
          title: "DialKit",
          open: shellOpen,
          ...
          onOpenChange: handleRootOpenChange,
          toolbar: timelineToggle,
          children: panels.map((panel) => /* @__PURE__ */ jsx19(
            Panel,
            {
              panel,
              defaultOpen: true,
      ...
      ) }) : panels.map((panel) => /* @__PURE__ */ jsx19(
        Panel,
        {
          panel,
          defaultOpen: inline || defaultOpen,
...
import { useCallback as useCallback13, useEffect as useEffect14, useMemo as useMemo2, useRef as useRef18, useSyncExternalStore as useSyncExternalStore6 } from "react";
...
function PlayPauseButton({ id }) {
  ...
  return /* @__PURE__ */ jsx20(
    motion7.button,
    {
      ...
      whileTap: { scale: 0.9 },
      transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
      children: /* @__PURE__ */ jsx20("span", { style: { position: "relative", width: 16, height: 16 }, children: /* @__PURE__ */ jsx20(AnimatePresence5, { initial: false, mode: "wait", children: playing ? /* @__PURE__ */ jsx20(
        motion7.svg,
        {
          viewBox: "0 0 24 24",
          fill: "none",
...
var TimelineSection = memo(function TimelineSection2({
  ...
  return /* @__PURE__ */ jsxs12("div", { className: "dialkit-timeline-section", children: [
    /* @__PURE__ */ jsxs12("div", { className: "dialkit-timeline-header", "data-open": open || void 0, children: [
      /* @__PURE__ */ jsx20("div", { className: "dialkit-timeline-identity", children: /* @__PURE__ */ jsx20("span", { className: "dialkit-timeline-title", children: meta.name }) }),
      !open && /* @__PURE__ */ jsx20(
        TimelineOverview,
        {
          id: meta.id,
              ...
              /* @__PURE__ */ jsxs12(
                "div",
                {
                  ...
                  children: [
                    ...
                    majorTicks.map((t) => /* @__PURE__ */ jsx20("div", { className: "dialkit-timeline-tick", style: { left: (t - safeViewStart) * pxPerSecond }, children: /* @__PURE__ */ jsx20("span", { className: "dialkit-timeline-tick-label", children: formatRulerSeconds(t, majorStep) }) }, t))
                  ]
                }
              )
            ] }),
  ...
  return /* @__PURE__ */ jsxs12(Fragment5, { children: [
    ...
    /* @__PURE__ */ jsx20(
      "div",
      {
        ...
        onLostPointerCapture: handlePointerCancel,
        title: barTitle,
        children: composite ? /* @__PURE__ */ jsx20(Fragment5, { children: width > 56 && /* @__PURE__ */ jsx20("span", { className: "dialkit-timeline-clip-duration", children: durationText }) }) : isSteps ? /* @__PURE__ */ jsxs12(Fragment5, { children: [
          steps.map((step) => {
...
function ShortcutsMenu({ panelId }) {
  ...
  return /* @__PURE__ */ jsxs13(Fragment6, { children: [
    ...
    createPortal5(
      /* @__PURE__ */ jsx22(AnimatePresence6, { children: isOpen && /* @__PURE__ */ jsxs13(
        motion8.div,
        {
          ref: dropdownRef,
