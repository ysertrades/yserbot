...
const ECONOMY_SHOWCASE_TEMPLATE = {
  embeds: [{
    title: null,
    description: 'Every way to earn, play, and spend coins on **QuantLab** — fishing, mining, trivia, daily rewards, jobs, the bank, the shop, casino games, and the daily lottery. Use `/help` for the full command list.',
    color: '#5AC8AA',
    footer: 'QuantLab Economy',
    footerIcon: null,
    thumbnail: null,
